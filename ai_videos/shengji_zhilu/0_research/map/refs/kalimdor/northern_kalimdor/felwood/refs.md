...
| 文件 | 来源 | 尺寸 | 版本 |
|---|---|---|---|
| `WorldMap-Felwood_c60.jpg` | File:WorldMap-Felwood c60.jpg | 1002 × 668 | **经典旧世 1.12（c60）** |

## 怎么用它

1. **人眼核点位**：对着它看我们生成的点位图（`../../../images/zones/felwood.png`）标得对不对。
...
抓取：`python tools/fetch_wow_maps.py --zone felwood`
