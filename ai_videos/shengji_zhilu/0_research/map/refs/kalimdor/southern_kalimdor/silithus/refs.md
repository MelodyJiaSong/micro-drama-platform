...
| 文件 | 来源 | 尺寸 | 版本 |
|---|---|---|---|
| `WorldMap-Silithus_c60.jpg` | File:WorldMap-Silithus c60.jpg | 1002 × 668 | **经典旧世 1.12（c60）** |
| `microdungeons/WorldMap-MicroDungeon-Silithus-TwilightsRun.jpg` | File:WorldMap-MicroDungeon-Silithus-TwilightsRun.jpg | 1002 × 668 | **微型地下城** |

## 怎么用它

1. **人眼核点位**：对着它看我们生成的点位图（`../../../images/zones/silithus.png`）标得对不对。
...
抓取：`python tools/fetch_wow_maps.py --zone silithus`
