...
| 文件 | 来源 | 尺寸 | 版本 |
|---|---|---|---|
| `WorldMap-StonetalonMountains.jpg` | File:WorldMap-StonetalonMountains.jpg | 1002 × 668 | **⚠ 现行零售版（无经典变体）** |

## 怎么用它

1. **人眼核点位**：对着它看我们生成的点位图（`../../../images/zones/stonetalon_mountains.png`）标得对不对。
...
抓取：`python tools/fetch_wow_maps.py --zone stonetalon_mountains`
